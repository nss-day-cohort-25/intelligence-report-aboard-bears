const rapsheetdata = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "list-items": [
        "item1": "American popular music (murdered after the release of \"I Kissed a Girl\")",
        "item2": "National Average IQ (decreased by 3 points due to Teenage Dream)",
        "item3": "All parents of teenage girls"
      ]
    }
  ]
}
...
const rapSheetBuilder = () => {
  ...
  h2element.textContent = rapsheetdata.title
  jsbuilder.appendChild(h2element)
